...
function showVisit(val){
	RequestFile("getData.php?op=visit&cid="+val,"Visit") ;
}

function showDiag(val){
	alert(val);
	RequestFile("getData.php?op=diag&servicex="+val,"Diagnosis") ;
}

function showRx(vals){

	alert(vals);
	RequestFile("getData.php?op=rx&servicex="+val,"Rx") ;
}
